...
namespace Stock_Data_Api.Migrations
{
    ...
    [Migration("20240328234216_updateGroupArticlesTable")]
    partial class updateGroupArticlesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stock_Data_Api.Models.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stock_Data_Api.Models.Frequent_Entiities.TabArticles", b =>
                {
                    ...
                    b.Property<bool>("DoApplyDiscount")
                        .HasColumnType("bit");

                    b.Property<bool>("IsArticleVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsDiscountVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsItemTotalVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsQuantityVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsTaxVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsTotalDiscountVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsUnitPriceVisible")
                        .HasColumnType("bit");

                    b.Property<decimal>("PersonalizedRowAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("PersonalizedRowName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<int?>("ShippingCostsTaxId")
                        .HasColumnType("int");

                    b.Property<bool>("ShowShippingCosts")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Stock_Data_Api.Models.Cheque", b =>
                {
                    ...
                    b.HasOne("Stock_Data_Api.Models.Currency", "Currency")
                        .WithMany()
            ...
            modelBuilder.Entity("Stock_Data_Api.Models.Frequent_Entiities.TabArticles", b =>
                {
                    b.HasOne("Stock_Data_Api.Models.Tax", "ShippingCostsTax")
                        .WithMany()
                        .HasForeignKey("ShippingCostsTaxId");

                    b.Navigation("ShippingCostsTax");
                });
